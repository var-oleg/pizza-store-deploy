...
import {clearCart, removeCartItem, minusCart, plusCart} from "../redux/actions/cart";
...
const Cart = () => {
    ...
    const onClearCart = () => {
        if (window.confirm('Ви дійсно хочете очитити кошик?')) {
            dispatch(clearCart());
        }
    };

    const onRemoveCartItem = (id) => {
        if (window.confirm('Ви дійсно хочете видалити піци?')) {
                ...
                totalCount ? <div className="cart">
                    ...
                    <div className="cart__bottom">
                        ...
                        <div className="cart__bottom-buttons">
                            ...
                            <Button onClick={payPizzas} className="pay-btn" outline>
